...
export const PublicacionesTodos = () => {

    const { changeHandler, submitHandler, changeHandlerPub, changeHandlerImgPub, submitHandlerImgPub, publicaciones, getPublicaciones, like, SetIdUserIdReq, setIdpubli, comentarios, getComentarios } = HookPublicaciones();
                    ...
                    <nav className="nav nav-pills nav-pills menu-app header">
                       <ul className="nav nav-pills">
                            <li className="nav-item">
                                <a className="nav-link active" href="/todo"><i className='fa fa-home' style={{ fontSize: "16px" }}></i>&nbsp;Publicaciones&nbsp;</a>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <a className="nav-link disabled" href="/managers"><i className='fa fa-thumbs-up' style={{ fontSize: "16px" }}></i>&nbsp;Likes&nbsp;</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="/usuarios"><i className='fa fa-users' style={{ fontSize: "16px" }}></i>&nbsp;Usuarios&nbsp;</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link disabled" href="/departments"><i className='fa fa-user' style={{ fontSize: "16px" }}></i>&nbsp;Perfil&nbsp;</a>
                            </li>
                            <li className="nav-item">
